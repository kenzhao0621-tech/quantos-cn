...
def main(argv: list[str] | None = None) -> int:
    ...
    p_check.add_argument("--provider", help="Filter providers (e.g. akshare)")
    ...
    p_fetch.add_argument("--live-only", action="store_true", help="Exclude manual_snapshot from routing")
