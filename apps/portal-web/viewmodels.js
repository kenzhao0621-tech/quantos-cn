...
(function (global) {
  ...
  function fromScreener(res) {
    ...
    return {
      ...
      dataCutoff: d.data_cutoff || d.as_of_date || "—",
      ...
      rows: (d.candidates || []).map((c) => ({
        ...
        pe: c.pe,
        pb: c.pb,
        disclosure_flag: c.disclosure_flag || "",
        data_cutoff: c.data_cutoff,
        model_version: c.model_version,
        forecast_horizon: c.forecast_horizon,
        valid_for_purchase: c.valid_for_purchase,
        tradability_status: c.tradability_status,
        tradability_blockers: c.tradability_blockers || [],
        expected_return_lo_pct: c.expected_return_lo_pct,
        expected_return_hi_pct: c.expected_return_hi_pct,
        downside_risk_pct: c.downside_risk_pct,
        crash_risk: c.crash_risk,
        liquidity_score: c.liquidity_score,
        estimated_round_trip_cost_cny: c.estimated_round_trip_cost_cny,
        ...
        regime_compatibility: c.regime_compatibility,
        validation_status: c.validation_status,
        purged_kfold_passed: c.purged_kfold_passed,
        affordable_lots: c.affordable_lots,
        suggested_qty: c.suggested_qty,
        max_suggested_position_cny: c.max_suggested_position_cny,
