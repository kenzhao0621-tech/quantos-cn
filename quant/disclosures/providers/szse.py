"""SZSE official disclosure provider."""
...
class SZSEDisclosureProvider:
    name = "szse_official"
    source_class = "SZSE_LISTED_ANNOUNCEMENTS"
    ...
    def fetch_announcements(
        ...
        result.rows = [r for r in result.rows if r.get("exchange") == "SZSE"]
