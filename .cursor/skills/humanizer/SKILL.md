...
version: 2.8.0
description: |
  Final-pass tone editing: remove AI writing patterns while preserving facts,
  numbers, quotes, and code meaning. Use after drafts are complete for
  naturalness and voice. Do NOT use to fabricate identity, evade academic
  integrity checks, or change factual content. Not for video hooks (use
  short-video-opening-optimizer) or initial drafting.
license: MIT
