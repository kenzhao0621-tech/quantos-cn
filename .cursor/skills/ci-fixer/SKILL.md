...
name: ci-fixer
description: >-
  Fix CI pipeline failures only. Reproduce failing checks, inspect logs, apply
  minimal targeted fixes. Use when GitHub Actions or CI checks fail on a PR.
  Do NOT use for local debugging (systematic-debugging) or unrelated refactors.
---
