...
name: impeccable
description: >-
  Final UI visual polish only: spacing, typography, hierarchy, consistency.
  Use after frontend-design implementation for polish pass. Do NOT use for
  initial design planning (ui-ux-pro-max) or building new components
  (frontend-design). Not for backend tasks.
