...
description: >-
  Persist long-running task state in task_plan.md, findings.md, progress.md.
  Use for multi-session complex work after plan exists. Do NOT use for initial
  ideation (brainstorming) or one-shot context (context-pack).
user-invocable: true
