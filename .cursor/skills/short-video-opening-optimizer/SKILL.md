...
description: >-
  Optimize short-form video openings only — hooks, first 3–10 seconds, retention
  for TikTok/Reels/Shorts. Use when the user asks about video hooks, opening
  lines, first-frame retention, or Hook Briefs. Do NOT use for full scripts,
  long-form rewriting, or general copywriting.
