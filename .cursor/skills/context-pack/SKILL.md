...
name: context-pack
description: >-
  Build one-time compact task context from repo briefing before execution.
  Use after repo-cartographer or for unfamiliar repos. Do NOT manage long-term
  task state (planning-with-files) or replace full repo scans.
metadata:
